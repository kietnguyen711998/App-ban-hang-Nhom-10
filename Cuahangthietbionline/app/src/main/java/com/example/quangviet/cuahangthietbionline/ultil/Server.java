package com.example.quangviet.cuahangthietbionline.ultil;

public class Server {
    //public  static  String localhost="quangvietntdmobileshop.000webhostapp.com";
    public static String localhost = "192.168.1.9:81";
    ...
    public static String Duongdansanphamnoibat = "http://"+localhost+"/server/getsanphamnoibat.php";
